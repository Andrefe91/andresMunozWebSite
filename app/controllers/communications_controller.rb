class CommunicationsController < ApplicationController
  ...
  def create
    begin
      ...
      @communication = Communication.new
      @communication.errors.add(:base, "Communication parameters are missing")
      render partial: "pages/communications/form", locals: { communication: @communication }, status: :unprocessable_entity
    end
  end
